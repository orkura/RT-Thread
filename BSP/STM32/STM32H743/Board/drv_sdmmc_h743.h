...
#ifndef DRV_SDMMC_H743_H
#define DRV_SDMMC_H743_H
...
#define SDIO_MASKR_ALL \
    (SDMMC_MASK_CCRCFAILIE | SDMMC_MASK_DCRCFAILIE | SDMMC_MASK_CTIMEOUTIE | SDMMC_MASK_DTIMEOUTIE | \
